    ...
    <footer className="bg-foreground text-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            <Link to="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">Guidora</span>
            </Link>
            <p className="text-background/70 text-sm max-w-sm mb-6">
              Connecting students with skilled mentors across technology, science, 
              business, and more. Your career growth starts here.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-background/10 text-center text-sm text-background/60">
          <p>© {currentYear} Guidora. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
